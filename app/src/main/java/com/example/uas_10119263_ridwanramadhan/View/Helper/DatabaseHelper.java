...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //Memasukkan data ke database
    public boolean updateData(String id, String item, String kategori, String catatan) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL2, item);
        contentValues.put(COL3, catatan);
        contentValues.put(COL4, dateString);
        contentValues.put(COL5, kategori);
        contentValues.put(COL6, timeString);
        Log.d(TAG, "updateData: Inserting " + item + " to " + TABLE_NAME);
